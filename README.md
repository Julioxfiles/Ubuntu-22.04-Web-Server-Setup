...
Note: As is obvious and expected, some words like: your_server_ip, your_ssh_file, your_domain, your_new_user, dbAdmin, your_db_password and others can or should be replaced with your server connection information or each user's own passwords. It is the responsability of each user the use of this manual.
