...
Note: As expected, some words like: your_server_ip, your_ssh_file, your_domain, your_new_user, dbAdmin, your_db_password and others can or should be replaced with your server connection information or each user's own passwords
